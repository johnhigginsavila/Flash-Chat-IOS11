...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Flash_Chat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Flash_Chat11AppDelegate")
...
SWIFT_CLASS("_TtC10Flash_Chat18ChatViewController")
@interface ChatViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
@property (nonatomic, strong) IBOutlet NSLayoutConstraint * _Null_unspecified heightConstraint;
...
SWIFT_CLASS("_TtC10Flash_Chat17CustomMessageCell")
...
SWIFT_CLASS("_TtC10Flash_Chat19LogInViewController")
...
SWIFT_CLASS("_TtC10Flash_Chat22RegisterViewController")
@interface RegisterViewController : UIViewController
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified emailTextfield;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified passwordTextfield;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)registerPressed:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
